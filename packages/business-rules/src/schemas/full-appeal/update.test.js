...
describe('schemas/full-appeal/update', () => {
  ...
  describe('update', () => {
    ...
    describe('eligibility', () => {
      ...
      describe('eligibility.typeOfPlanningApplication', () => {
        it('should throw an error when given an invalid value', async () => {
          appeal.eligibility.typeOfPlanningApplication = 'appeal';

          await expect(() => update.validate(appeal, config)).rejects.toThrow(
            `eligibility.typeOfPlanningApplication must be one of the following values: ${Object.values(
              TYPE_OF_PLANNING_APPLICATION,
            ).join(', ')}`,
          );
        });
        ...
        it('should throw an error when not given a value', async () => {
          delete appeal.eligibility.typeOfPlanningApplication;

          await expect(() => update.validate(appeal, config)).rejects.toThrow(
            'eligibility.typeOfPlanningApplication is a required field',
          );
        });
      });
    });
